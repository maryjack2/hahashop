...
<html lang="en">
  <head>
    ...
    <!-- Favicon-->
    <link rel="shortcut icon" href="{{ asset('img/favicon.ico') }}" type="img/img">
    <!-- Modernizr-->
...
<!-- ? -->
        <div class="container-fluid text-white m-0 ">  
          <!-- Navbar Header  -->
          <a href="index.html" class="navbar-brand "><img src="{{asset('images/logo.png') }}" alt="..." style="width: 70px; "></a>
...
<!-- cart item-->
                  <div class="dropdown-item cart-product">
                    <div class="d-flex align-items-center">
                      <div class="img"><img src="{{asset('images/hoodie-man-1.png') }}" alt="..." class="img-fluid"></div>
   ...
   <section class="hero hero-home no-padding ">
      ...
      <div class="owl-carousel owl-theme hero-slider">
        <div style="background: {{asset('images/hero-bg.jpg') }};" class="item d-flex align-items-center has-pattern">
          <div class="container">
            <div class="row">
              <div class="col-lg-6 text-white">
                <h1>Hello</h1>
                <p>We host some events near you! </p>
                <a href="#" class="btn wide shop-now" style="background-color:#62CBC0;color:#fff;">Shop Now<i class="icon-bag"> </i></a>
              </div>
            </div>
          </div>
        </div>
        <div style="background: {{asset('images/hero-bg-2.jpg') }};" class="item d-flex align-items-center">
          <div class="container">
            <div class="row">
              <div class="col-lg-6 text-white">
                <h1>Labore et dolore magna aliqua</h1>
                <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p><a href="#" class="btn wide shop-now" style="background-color:#62CBC0;color:#fff;">Shop Now<i class="icon-bag">  </i></a>
              </div>
            </div>
          </div>
        </div>
        <div style="background: {{asset('images/hero-bg-3.jpg') }};" class="item d-flex align-items-center">
          <div class="container">
            <div class="row">
              <div class="col-lg-6 text-white">
                <h1>Sed do eiusmod tempor</h1>
                <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p><a href="#" class="btn btnc wide shop-now"style="background-color:#62CBC0;color:#fff;">Shop Now<i class="icon-bag"></i></a>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="women-collection">
      <div class="container">
        <header class="text-center">
          <h2 class="text-uppercase"><small>New Products</small>Hot Collection</h2>
        </header>
        <!-- Products Slider-->
        <div class="owl-carousel owl-theme products-slider">
          ...
          <div class="item">
            <div class="product is-gray">
              <div class="image d-flex align-items-center justify-content-center">
                <img src="{{asset('images/P7.jpg') }}" alt="product" class="img-fluid">
                <div class="hover-overlay d-flex align-items-center justify-content-center">
                  <div class="CTA d-flex align-items-center justify-content-center"><a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a><a href="detail.html" class="visit-product active"><i class="icon-search"></i>View</a><a href="#" data-toggle="modal" data-target="#exampleModal" class="quick-view"><i class="fa fa-arrows-alt"></i></a></div>
                </div>
              </div>
          ...
          <div class="item">
            <div class="product is-gray">
              <div class="image d-flex align-items-center justify-content-center"><img src="{{ asset('images/p3.jpg') }}" alt="product" class="img-fluid">
                <div class="hover-overlay d-flex align-items-center justify-content-center">
                  <div class="CTA d-flex align-items-center justify-content-center"><a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a><a href="detail.html" class="visit-product active"><i class="icon-search"></i>View</a><a href="#" data-toggle="modal" data-target="#exampleModal" class="quick-view"><i class="fa fa-arrows-alt"></i></a></div>
                </div>
              </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body"> 
            ...
            <div class="row d-flex align-items-center">
              <div class="image col-lg-5"><img src="{{ asset('images/P1.jpg') }}" alt="..." class="img-fluid d-block"></div>
              <div class="details col-lg-7">
                <h2>Leather bag</h2>
                <ul class="price list-inline">
                  <li class="list-inline-item current">NT.5000</li>
                  <li class="list-inline-item original">NT.5000</li>
                </ul>
        ...
        <div class="container">
          <div class="row">
            <div class="info col-lg-4">
              <div class="logo" style="width: 180px;"><img src="images/logo.png" alt="..."></div>
        ...
        <div class="container-fluid">
          ...
          <div class="row d-flex align-items-center mb-0">
            ...
            <div class="col-lg-12 d-flex justify-content-center">
              <!-- Language Dropdown-->
              <div class="dropdown show"><a id="langsDropdown" href="https://example.com" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle"><img src="{{ asset('images/united-kingdom.svg') }}" alt="english">English</a>
                <div aria-labelledby="langsDropdown" class="dropdown-menu dropdown-menu-right"><a href="#" class="dropdown-item"><img src="{{ asset('images/germany.svg') }}" alt="german">Chinese</a></div>
              </div>
              <!-- Currency Dropdown-->
